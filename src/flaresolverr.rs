...
impl FlareSolverr {
    ...
    pub async fn create_session(&self) -> Result<String, Box<dyn std::error::Error>> {
        ...
        // Retry up to 3 times with 5s delay - FlareSolverr may need time for Chrome init
    ...
    async fn parse_response(
        ...
        // FlareSolverr returns HTTP 500 with JSON body for application errors,
        // so always try to parse JSON first
